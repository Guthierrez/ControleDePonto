	...
	<body>
		...
		<div id="show-funcionario" class="content scaffold-show" role="main">
			...
			<ol class="property-list funcionario">
				...
				<g:if test="${funcionarioInstance?.cargaHorariaMensal}">
				<li class="fieldcontain">
					<span id="cargaHorariaMensal-label" class="property-label"><g:message code="funcionario.cargaHorariaMensal.label" default="Carga Horaria Mensal" /></span>
					
						<span class="property-value" aria-labelledby="cargaHorariaMensal-label"><g:fieldValue bean="${funcionarioInstance}" field="cargaHorariaMensal"/></span>
