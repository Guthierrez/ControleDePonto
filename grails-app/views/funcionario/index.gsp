		...
		<div id="list-funcionario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="cargaHorariaMensal" title="${message(code: 'funcionario.cargaHorariaMensal.label', default: 'Carga Horaria Mensal')}" />
				...
				<g:each in="${funcionarioInstanceList}" status="i" var="funcionarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: funcionarioInstance, field: "cargaHorariaMensal")}</td>
